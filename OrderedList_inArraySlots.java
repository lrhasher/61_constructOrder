...
public class OrderedList_inArraySlots
     ...
     */
     private int champIndex( ArrayList<Integer> challengers) {
        ...
        for( i = 1, indexOfSmallest = 0; i < challengers.size(); i++){
            if(  challengers.get(indexOfSmallest) == null)
                indexOfSmallest++;
            else if(challengers.get(i) != null
                 && challengers.get(indexOfSmallest) > challengers.get(i))
                indexOfSmallest = i;
        }
